...
/*
 * MediaTek clock driver for MT6580 SoC
 *
...
#define MT6580_CLKSQ_STB_CON0		0x18
#define MT6580_PLL_ISO_CON0		0x24
#define MT6580_PLL_FMAX			(2000UL * MHZ)
...
static int mt6580_mcucfg_probe(struct udevice *dev)
{
	void __iomem *base;
...
static int mt6580_apmixedsys_probe(struct udevice *dev)
{
	...
	ret = mtk_common_clk_init(dev, &mt6580_clk_tree);
	if (ret)
		return ret;

	/* reduce clock square disable time */
	writel(0x50001, priv->base + MT6580_CLKSQ_STB_CON0);
	/* extend control timing to 1us */
	writel(0x888, priv->base + MT6580_PLL_ISO_CON0);
...
static int mt6580_infracfg_probe(struct udevice *dev)
{
	return mtk_common_clk_gate_init(dev, &mt6580_clk_tree, infra_cgs);
}

static int mt6580_pericfg_probe(struct udevice *dev)
{
	return mtk_common_clk_gate_init(dev, &mt6580_clk_tree, peri_cgs);
}

static int mt6580_hifsys_probe(struct udevice *dev)
{
	return mtk_common_clk_gate_init(dev, &mt6580_clk_tree, hif_cgs);
}

static int mt6580_ethsys_probe(struct udevice *dev)
{
	return mtk_common_clk_gate_init(dev, &mt6580_clk_tree, eth_cgs);
}

static int mt6580_ethsys_hifsys_bind(struct udevice *dev)
{
	int ret = 0;
...
static const struct udevice_id mt6580_infracfg_compat[] = {
	{ .compatible = "mediatek,mt6580-infracfg", },
	{ }
};

static const struct udevice_id mt6580_pericfg_compat[] = {
	{ .compatible = "mediatek,mt6580-pericfg", },
	{ }
};

static const struct udevice_id mt6580_ethsys_compat[] = {
	{ .compatible = "mediatek,mt6580-ethsys" },
	{ }
};

static const struct udevice_id mt6580_hifsys_compat[] = {
	{ .compatible = "mediatek,mt6580-hifsys" },
	{ }
};

static const struct udevice_id mt6580_mcucfg_compat[] = {
...
U_BOOT_DRIVER(mtk_mcucfg) = {
	.name = "mt6580-mcucfg",
	.id = UCLASS_SYSCON,
	.of_match = mt6580_mcucfg_compat,
	.probe = mt6580_mcucfg_probe,
...
U_BOOT_DRIVER(mtk_clk_infracfg) = {
	.name = "mt6580-infracfg",
	.id = UCLASS_CLK,
	.of_match = mt6580_infracfg_compat,
	.probe = mt6580_infracfg_probe,
...
U_BOOT_DRIVER(mtk_clk_pericfg) = {
	.name = "mt6580-pericfg",
	.id = UCLASS_CLK,
	.of_match = mt6580_pericfg_compat,
	.probe = mt6580_pericfg_probe,
	.priv_auto	= sizeof(struct mtk_cg_priv),
	.ops = &mtk_clk_gate_ops,
	.flags = DM_FLAG_PRE_RELOC,
};
...
U_BOOT_DRIVER(mtk_clk_hifsys) = {
	.name = "mt6580-clock-hifsys",
	.id = UCLASS_CLK,
	.of_match = mt6580_hifsys_compat,
	.probe = mt6580_hifsys_probe,
	.bind = mt6580_ethsys_hifsys_bind,
	.priv_auto	= sizeof(struct mtk_cg_priv),
	.ops = &mtk_clk_gate_ops,
};

U_BOOT_DRIVER(mtk_clk_ethsys) = {
	.name = "mt6580-clock-ethsys",
	.id = UCLASS_CLK,
	.of_match = mt6580_ethsys_compat,
	.probe = mt6580_ethsys_probe,
	.bind = mt6580_ethsys_hifsys_bind,
	.priv_auto	= sizeof(struct mtk_cg_priv),
	.ops = &mtk_clk_gate_ops,
};
